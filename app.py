...
# ============================================
# CSS STYLING - FIXED (NO HEADER HIDING)
# ============================================
def load_css():
    """Load custom CSS for professional look."""
    st.markdown("""
    <style>
        /* Only hide Streamlit's default menu and footer */
...
def render_data_preview(df):
    """Render data preview with stats - TITLE VISIBLE."""
    if df is not None and not df.empty:
        # This heading WILL show now
...
def render_welcome():
    """Render welcome message using Streamlit components (no HTML)."""
    st.markdown("## 🚀 Welcome to AI Data Analyst")
    st.markdown("Ask questions about your data in natural language and get instant insights with beautiful visualizations.")
...
def main():
    ...
    if not query:
        render_header("")
        render_welcome()  # <-- This shows the welcome headings
    else:
        render_header(query)
