...
def load_css():
    ...
    st.markdown("""
    <style>
        /* Only hide Streamlit's default elements, NOT your custom ones */
        #MainMenu {visibility: hidden;}
        footer {visibility: hidden;}
        /* Remove this line: header {visibility: hidden;} */
        
        /* Your custom header styling - this will show */
        .dashboard-header {
        ...
        /* Section Headers - This will show */
        .section-title {
            font-size: 1.2rem;
            font-weight: 600;
            color: #1a1a2e;
